...
-- close at any practical fuel (it bypasses the typeCheck fast-path).
-- The substitution-based `SubstEval.subCheck five_
...
example : SubstEval.subCheck 200 appendArrays
