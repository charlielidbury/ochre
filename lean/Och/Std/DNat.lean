...
example : Och.checkSubtype 2000 zero_ Nat_ = .ok true := by native_decide
example : Och.checkSubtype 2000 one_ Nat_ = .ok true := by native_decide
example : Och.checkSubtype 2000 two_ Nat_ = .ok true := by native_decide
-- three_/four_/five_ ⊑ Nat_: now structural-only; bench-only.

-- ── Negative subtype checks ─────────────────────────────────

example : Och.checkSubtype 2000 Nat_ zero_ = .ok false := by native_decide
...
example : Och.checkSubtype 2000 Std.Bool Nat_ = .ok false := by native_decide
example : Och.checkSubtype 2000 zero_ one_ = .ok false := by native_decide
