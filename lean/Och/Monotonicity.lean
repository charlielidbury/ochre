            ...
            | some f₂ =>
              ...
              | some a₂ =>
                ...
                | mu x_mu ann_mu body_mu =>
                  ...
                  subst hf₂_eq
                  -- Both annotations are the SAME (ann_mu). absEval checks
                  -- annotation SYNTACTICALLY, so both envs take same path.
                  simp only at h₁ h₂
                  sorry -- mu-app case: TODO factor out as lemma
                | type =>
          ...
          | some f₂ =>
            ...
            | some a₂ =>
              ...
              | mu x_mu ann_mu body_mu =>
                ...
                subst hf₂_eq
                simp only at h₁ h₂
                sorry -- mu-app case in app_cong: same as refl above
              | type =>
                simp only at h₁; cases h₁; exact .top τ₂
              | var v₁ =>
                cases f₂ with
