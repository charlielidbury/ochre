...
%   \begin{mathpar}
%     \forall S, v, t. \left[
%     (\emptyset \vdash S : \_ \movearrowabs t)
%     \text{ and } (\emptyset \vdash S : \_ \movearrowconc v)
%     \text{ implies } (\emptyset \vdash v: t)
%     \right]
%   \end{mathpar}
%   \caption{The central soundness property of Ochre's type system}
% \end{figure}
...
% \begin{mathpar}
%   \text{let} \, R_s(S) \triangleq  \forall \Omega, \Delta, S, v, t. \left[
%     (\emptyset \vdash S : \_ \movearrowabs t)
%     \text{ and } (\emptyset \vdash S : \_ \movearrowconc v)
%     \text{ implies } (\emptyset \vdash v: t)
%     \right]
