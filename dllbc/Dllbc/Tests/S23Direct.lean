...
def suffHonest : Term := pure{ Le (len *%vfT) %fuelT }
...
example : progRejects (qsUnder (pure{
...
example : progRejects (qsUnder partHonest (pure{
...
example : progRejects (qsUnder partHonest qsHonest (pure{ Unit }) .unit)
