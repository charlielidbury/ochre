...
* `Pss/Context/DeBruijn.lean` / `Pss/Mpss/DeBruijnTypeSafety.lean` —
  ...
  existing three/four/five/six/seven/eight-head stack payload APIs, plus reverse
  adapters from the existing three/four/five/six/seven/eight-head APIs to the generic
  length-indexed
