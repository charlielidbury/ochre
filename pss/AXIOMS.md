...
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-three-head `MEqRed.top`
  ...
  `Pss/DeBruijnSanity.lean`; no headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-three-head
  `MEqRed.app` leaf `BetaInstantiationPreservesMEqRedUnderThirtyThreeHeadsStack.app`,
  assembling instantiated function and argument premises with `MEqRed.app`.
  Added the endpoint to `Pss/DeBruijnSanity.lean`; no headline axiom-count
  change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-three-head reflexive
  equivalence leaf `BetaInstantiationPreservesMEqRedUnderThirtyThreeHeadsStack.refl`,
  extending scoped-term instantiation to depth `Γ.depth + 33`. Added the
  endpoint to `Pss/DeBruijnSanity.lean`; no headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-three-head variable
  equivalence leaf `BetaInstantiationPreservesMEqRedUnderThirtyThreeHeadsStack.var`,
  routing scoped de Bruijn variables through the verified thirty-three-head
  reflexive leaf. Added the endpoint to `Pss/DeBruijnSanity.lean`; no headline
  axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-three-head top-application
  leaf `BetaInstantiationPreservesMEqRedUnderThirtyThreeHeadsStack.tAp`, using
  the thirty-three-head reflexive leaf to feed `MEqRed.tAp`. Added the endpoint
  to `Pss/DeBruijnSanity.lean`; no headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-three-head projection
  leaf `BetaInstantiationPreservesMEqRedUnderThirtyThreeHeadsStack.pro`, delegating
  the instantiated equivalence-binding case to the generic preserved-head
  projection helper. Added the endpoint to `Pss/DeBruijnSanity.lean`; no headline
  axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — exposed the thirty-three-head constructor
  payload frontiers `BetaInstantiationPreservesMEqRedUnderThirtyThreeHeadsFunStackPayload`,
  `BetaInstantiationPreservesMEqRedUnderThirtyThreeHeadsBetStackPayload`, and
  `BetaInstantiationPreservesMEqRedUnderThirtyThreeHeadsFOpStackPayload`. Added
  the endpoints to `Pss/DeBruijnSanity.lean`; no headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — assembled the thirty-three-head constructor
  dispatcher `BetaInstantiationPreservesMEqRedUnderThirtyThreeHeadsStack.of_constructors`,
  routing structural cases to the thirty-three leaves and binder cases to the
  thirty-three payload frontiers. Added the endpoint to `Pss/DeBruijnSanity.lean`;
  no headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — opened the thirty-four-head stack surface
  `BetaInstantiationPreservesMEqRedUnderThirtyFourHeadsStack` and its generic
  specialization `.of_generic`, giving the thirty-three-head binder payloads a
  recursive target. Added both endpoints to `Pss/DeBruijnSanity.lean`; no
  headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — opened the thirty-five-head stack surface
  `BetaInstantiationPreservesMEqRedUnderThirtyFiveHeadsStack` and its generic
  specialization `.of_generic`, giving the thirty-four-head binder payloads a
  recursive target. Added both endpoints to `Pss/DeBruijnSanity.lean`; no
  headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added thirty-four-head prevalidity
...
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-four-head `MEqRed.top`
  ...
  `Pss/DeBruijnSanity.lean`; no headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-five-head `MEqRed.top`
  leaf `BetaInstantiationPreservesMEqRedUnderThirtyFiveHeadsStack.top`, reusing
  the thirty-five-head prevalidity transport. Added the endpoint to
  `Pss/DeBruijnSanity.lean`; no headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-four-head
  `MEqRed.app` leaf `BetaInstantiationPreservesMEqRedUnderThirtyFourHeadsStack.app`,
  assembling instantiated function and argument premises with `MEqRed.app`.
  Added the endpoint to `Pss/DeBruijnSanity.lean`; no headline axiom-count
  change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-five-head
  `MEqRed.app` leaf `BetaInstantiationPreservesMEqRedUnderThirtyFiveHeadsStack.app`,
  assembling instantiated function and argument premises with `MEqRed.app`.
  Added the endpoint to `Pss/DeBruijnSanity.lean`; no headline axiom-count
  change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-four-head reflexive
  ...
  endpoint to `Pss/DeBruijnSanity.lean`; no headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-five-head reflexive
  equivalence leaf `BetaInstantiationPreservesMEqRedUnderThirtyFiveHeadsStack.refl`,
  extending scoped-term instantiation to depth `Γ.depth + 35`. Added the
  endpoint to `Pss/DeBruijnSanity.lean`; no headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-four-head variable
  equivalence leaf `BetaInstantiationPreservesMEqRedUnderThirtyFourHeadsStack.var`,
  routing scoped de Bruijn variables through the verified thirty-four-head
  reflexive leaf. Added the endpoint to `Pss/DeBruijnSanity.lean`; no headline
  axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-five-head variable
  equivalence leaf `BetaInstantiationPreservesMEqRedUnderThirtyFiveHeadsStack.var`,
  routing scoped de Bruijn variables through the verified thirty-five-head
  reflexive leaf. Added the endpoint to `Pss/DeBruijnSanity.lean`; no headline
  axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-four-head top-application
  ...
  to `Pss/DeBruijnSanity.lean`; no headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-five-head top-application
  leaf `BetaInstantiationPreservesMEqRedUnderThirtyFiveHeadsStack.tAp`, using
  the thirty-five-head reflexive leaf to feed `MEqRed.tAp`. Added the endpoint
  to `Pss/DeBruijnSanity.lean`; no headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-four-head projection
  ...
  projection helper. Added the endpoint to `Pss/DeBruijnSanity.lean`; no headline
  axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-five-head projection
  leaf `BetaInstantiationPreservesMEqRedUnderThirtyFiveHeadsStack.pro`, delegating
  the instantiated equivalence-binding case to the generic preserved-head
  projection helper. Added the endpoint to `Pss/DeBruijnSanity.lean`; no headline
  axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — exposed the thirty-five-head constructor
  payload frontiers `BetaInstantiationPreservesMEqRedUnderThirtyFiveHeadsFunStackPayload`,
...
* `Pss/Mpss/DeBruijnTypeSafety.lean` — assembled the thirty-five-head constructor
  ...
  no headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — opened the thirty-six-head stack surface
  `BetaInstantiationPreservesMEqRedUnderThirtySixHeadsStack` and its generic
  specialization `.of_generic`, giving the thirty-five-head binder payloads a
  recursive target. Added both endpoints to `Pss/DeBruijnSanity.lean`; no
  headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added thirty-six-head prevalidity
  transport `BetaInstantiationPreservesPrevalidExtUnderThirtySixHeads`, reusing
  the generic preserved-head prevalidity helper at the new depth. Added the
  endpoint to `Pss/DeBruijnSanity.lean`; no headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-six-head `MEqRed.top`
  leaf `BetaInstantiationPreservesMEqRedUnderThirtySixHeadsStack.top`, reusing
  the checked thirty-six-head prevalidity transport. Added the endpoint to
  `Pss/DeBruijnSanity.lean`; no headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-six-head
  `MEqRed.app` leaf `BetaInstantiationPreservesMEqRedUnderThirtySixHeadsStack.app`,
  assembling instantiated function and argument premises with `MEqRed.app`.
  Added the endpoint to `Pss/DeBruijnSanity.lean`; no headline axiom-count
  change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-six-head reflexive
...
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-six-head variable
  ...
  `Pss/DeBruijnSanity.lean`; no headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-six-head type-application
...
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-six-head projection
  ...
  the endpoint to `Pss/DeBruijnSanity.lean`; no headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — exposed the thirty-six-head constructor
  payload frontiers `BetaInstantiationPreservesMEqRedUnderThirtySixHeadsFunStackPayload`,
  `BetaInstantiationPreservesMEqRedUnderThirtySixHeadsBetStackPayload`, and
  `BetaInstantiationPreservesMEqRedUnderThirtySixHeadsFOpStackPayload`. Added
  the endpoints to `Pss/DeBruijnSanity.lean`; no headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — assembled the thirty-six-head constructor
...
* `Pss/Mpss/DeBruijnTypeSafety.lean` — exposed the thirty-four-head constructor
  ...
  `BetaInstantiationPreservesMEqRedUnderThirtyFourHeadsFOpStackPayload`. Added
  the endpoints to `Pss/DeBruijnSanity.lean`; no headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — assembled the thirty-four-head constructor
  dispatcher `BetaInstantiationPreservesMEqRedUnderThirtyFourHeadsStack.of_constructors`,
  routing structural cases to the thirty-four leaves and binder cases to the
  thirty-four payload frontiers. Added the endpoint to `Pss/DeBruijnSanity.lean`;
  no headline axiom-count change.
* `Pss/Mpss/DeBruijnTypeSafety.lean` — added the thirty-one-head
