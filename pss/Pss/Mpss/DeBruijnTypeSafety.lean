...
/-- Stack-parametric equivalence-reduction β-instantiation under two
preserved context heads. The outer preserved head's annotation sees the
substituted `.sub` entry below one preserved head, so its bound is
instantiated at index `1`; the inner preserved head is instantiated at index
`0`. -/
def BetaInstantiationPreservesMEqRedUnderTwoHeadsStack : Type :=
  ∀ {Γ : Ctx} {bound arg head₁ head₂ lhs rhs : Term}
    ...
    WSubMStar Γ arg bound →
      MEqRed ({ bound := head₁, kind := kind₁ } ::
        ...
        MEqRed
          ...
          (Term.instantiate 2 (Term.shift 0 (Term.shift 0 arg)) lhs)
          (Term.instantiate 2 (Term.shift 0 (Term.shift 0 arg)) rhs)

/-- Stack-parametric equivalence-reduction β-instantiation under three
preserved context heads. This is the recursive body payload needed by the
two-head binder constructors. -/
def BetaInstantiationPreservesMEqRedUnderThreeHeadsStack : Type :=
  ∀ {Γ : Ctx} {bound arg head₁ head₂ head₃ lhs rhs : Term}
    ...
    WSubMStar Γ arg bound →
      MEqRed ({ bound := head₁, kind := kind₁ } ::
        ...
        MEqRed
          ...
          (Term.instantiate 3
            (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))) lhs)
          (Term.instantiate 3
            (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))) rhs)

/-- Stack-parametric equivalence-reduction β-instantiation under four
preserved context heads. This is the recursive body payload needed by the
three-head binder constructors. -/
def BetaInstantiationPreservesMEqRedUnderFourHeadsStack : Type :=
  ∀ {Γ : Ctx} {bound arg head₁ head₂ head₃ head₄ lhs rhs : Term}
...
def BetaInstantiationPreservesMEqRedUnderFourHeadsFunStackPayload : Type :=
  ∀ {Γ : Ctx} {bound arg head₁ head₂ head₃ head₄ t t' body body' : Term}
      {kind₁ kind₂ kind₃ kind₄ : CtxEntryKind},
    WSubMStar Γ arg bound →
      MEqRed ({ bound := head₁, kind := kind₁ } ::
          { bound := head₂, kind := kind₂ } ::
          { bound := head₃, kind := kind₃ } ::
...
/-- Constructor-facing `Me-Bet` frontier for four-head equivalence
β-instantiation. Its eventual adapter needs the four-preserved-head
β-target substitution-composition law. -/
def BetaInstantiationPreservesMEqRedUnderFourHeadsBetStackPayload : Type :=
  ∀ {Γ : Ctx} {bound arg head₁ head₂ head₃ head₄ t v v' body body' : Term}
      {kind₁ kind₂ kind₃ kind₄ : CtxEntryKind} {s : Stack},
    WSubMStar Γ arg bound →
      Term.Scoped
        (Ctx.depth ({ bound := head₁, kind := kind₁ } ::
...
/-- Constructor-facing `Me-FOp` frontier for four-head equivalence
β-instantiation under the operand `.equ` binder. -/
def BetaInstantiationPreservesMEqRedUnderFourHeadsFOpStackPayload : Type :=
  ∀ {Γ : Ctx} {bound arg head₁ head₂ head₃ head₄ t t' α body body' : Term}
      {kind₁ kind₂ kind₃ kind₄ : CtxEntryKind} {s : Stack},
    WSubMStar Γ arg bound →
      MEqRed ({ bound := head₁, kind := kind₁ } ::
          { bound := head₂, kind := kind₂ } ::
...
/-- Constructor-facing `Me-Fun` frontier for three-head equivalence
β-instantiation. The body premise lives under one additional `.sub` binder,
so discharging it requires the four-preserved-head payload. -/
def BetaInstantiationPreservesMEqRedUnderThreeHeadsFunStackPayload : Type :=
  ∀ {Γ : Ctx} {bound arg head₁ head₂ head₃ t t' body body' : Term}
      {kind₁ kind₂ kind₃ : CtxEntryKind},
    WSubMStar Γ arg bound →
      MEqRed ({ bound := head₁, kind := kind₁ } ::
          { bound := head₂, kind := kind₂ } ::
          { bound := head₃, kind := kind₃ } ::
...
/-- Constructor-facing `Me-Bet` frontier for three-head equivalence
β-instantiation. Its adapter additionally needs the three-preserved-head
β-target substitution-composition law. -/
def BetaInstantiationPreservesMEqRedUnderThreeHeadsBetStackPayload : Type :=
  ∀ {Γ : Ctx} {bound arg head₁ head₂ head₃ t v v' body body' : Term}
      {kind₁ kind₂ kind₃ : CtxEntryKind} {s : Stack},
    WSubMStar Γ arg bound →
      Term.Scoped
        (Ctx.depth ({ bound := head₁, kind := kind₁ } ::
...
/-- Constructor-facing `Me-FOp` frontier for three-head equivalence
β-instantiation under the operand `.equ` binder. -/
def BetaInstantiationPreservesMEqRedUnderThreeHeadsFOpStackPayload : Type :=
  ∀ {Γ : Ctx} {bound arg head₁ head₂ head₃ t t' α body body' : Term}
      {kind₁ kind₂ kind₃ : CtxEntryKind} {s : Stack},
    WSubMStar Γ arg bound →
      MEqRed ({ bound := head₁, kind := kind₁ } ::
          { bound := head₂, kind := kind₂ } ::
            ...
            MEqRed
              ({ bound := Term.instantiate 2
                ...
                { bound := Term.instantiate 0 arg head₃,
                  kind := kind₃ } :: Γ)
              (Stack.instantiate 3
                (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))) (α :: s))
              (Term.instantiate 3
                (Term.shift 0 (Term.shift 0 (Term.shift 0 arg)))
                (.abs t body))
              (Term.instantiate 3
...
/-- Constructor-facing `Me-Fun` frontier for two-head equivalence
β-instantiation. The body premise lives under one additional `.sub` binder,
so discharging it requires the three-preserved-head payload. -/
def BetaInstantiationPreservesMEqRedUnderTwoHeadsFunStackPayload : Type :=
  ∀ {Γ : Ctx} {bound arg head₁ head₂ t t' body body' : Term}
      {kind₁ kind₂ : CtxEntryKind},
    WSubMStar Γ arg bound →
      MEqRed ({ bound := head₁, kind := kind₁ } ::
          { bound := head₂, kind := kind₂ } ::
          { bound := bound, kind := .sub } :: Γ) [] t t' →
...
def BetaInstantiationPreservesMEqRedUnderTwoHeadsFOpStackPayload : Type :=
  ∀ {Γ : Ctx} {bound arg head₁ head₂ t t' α body body' : Term}
      {kind₁ kind₂ : CtxEntryKind} {s : Stack},
    WSubMStar Γ arg bound →
      MEqRed ({ bound := head₁, kind := kind₁ } ::
          { bound := head₂, kind := kind₂ } ::
          ...
          MEqRed ({ bound := α, kind := .equ } ::
            ...
            MEqRed
              ({ bound := Term.instantiate 1 (Term.shift 0 arg) head₁,
                  kind := kind₁ } ::
                { bound := Term.instantiate 0 arg head₂, kind := kind₂ } :: Γ)
              (Stack.instantiate 2 (Term.shift 0 (Term.shift 0 arg)) (α :: s))
              (Term.instantiate 2 (Term.shift 0 (Term.shift 0 arg))
                (.abs t body))
              (Term.instantiate 2 (Term.shift 0 (Term.shift 0 arg))
                (.abs t' body'))
...
`0`, and the discharged `.sub` tail is removed. -/
noncomputable def BetaInstantiationPreservesPrevalidExtUnderTwoHeads
    {Γ : Ctx} {bound arg head₁ head₂ : Term}
    {kind₁ kind₂ : CtxEntryKind} {s : Stack}
    (hArgBound : WSubMStar Γ arg bound)
    (hpv : PrevalidExt ({ bound := head₁, kind := kind₁ } ::
        { bound := head₂, kind := kind₂ } ::
...
/-- Prevalidity transport for β-instantiation under five preserved context
heads. The outer heads are instantiated at indices `4`, `3`, `2`, `1`, and
`0`, respectively, and the discharged `.sub` tail is removed. -/
noncomputable def BetaInstantiationPreservesPrevalidExtUnderFiveHeads
  ...
  have hHead₂Scoped : Term.Scoped (Γ.depth + 4) head₂ := by
    simpa [Ctx.depth, Nat.succ_eq_add_one, Nat.add_assoc] using
      prevalid_head_scoped hctxHead₂
  have hHead₁Scoped : Term.Scoped (Γ.depth + 5) head₁ := by
    simpa [Ctx.depth, Nat.succ_eq_add_one, Nat.add_assoc] using
      prevalid_head_scoped hctxSource
  have hHead₅InstScoped :
      Term.Scoped Γ.depth (Term.instantiate 0 arg head₅) :=
  ...
  have hHead₁InstScoped :
    ...
    Term.instantiate_scoped 4 (Γ.depth + 4)
      (Term.shift 0 (Term.shift 0 (Term.shift 0 (Term.shift 0 arg)))) head₁
      (by omega) hArgShiftShiftShiftShiftScoped hHead₁Scoped
  have hctxTail :
      Prevalid
        ({ bound := Term.instantiate 0 arg head₅, kind := kind₅ } :: Γ) := by
    cases kind₅ with
  ...
  have hctx :
    ...
    | sub => exact Prevalid.sub hctxMid₂ hHead₁InstScoped
    | equ => exact Prevalid.equ hctxMid₂ hHead₁InstScoped
  have hsSource : Stack.Scoped (Γ.depth + 6) s := by
    simpa [Ctx.depth, Nat.succ_eq_add_one, Nat.add_assoc] using
      PrevalidExt.stack_scoped hpv
  have hsTarget :
      Stack.Scoped (Γ.depth + 5)
        (Stack.instantiate 5
          (Term.shift 0
            (Term.shift 0 (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))))) s) :=
    Stack.Scoped.instantiate (by omega) hArgShiftShiftShiftShiftShiftScoped (by
      simpa [Nat.add_assoc] using hsSource)
  exact PrevalidExt.of_stack_scoped hctx hsTarget

/-- Prevalidity transport for β-instantiation under six preserved context
heads. The outer heads are instantiated at indices `5`, `4`, `3`, `2`, `1`,
and `0`, respectively, and the discharged `.sub` tail is removed. -/
noncomputable def BetaInstantiationPreservesPrevalidExtUnderSixHeads
    {Γ : Ctx} {bound arg head₁ head₂ head₃ head₄ head₅ head₆ : Term}
    {kind₁ kind₂ kind₃ kind₄ kind₅ kind₆ : CtxEntryKind} {s : Stack}
    (hArgBound : WSubMStar Γ arg bound)
    (hpv : PrevalidExt ({ bound := head₁, kind := kind₁ } ::
        { bound := head₂, kind := kind₂ } ::
  ...
  have hHead₂Scoped : Term.Scoped (Γ.depth + 5) head₂ := by
    simpa [Ctx.depth, Nat.succ_eq_add_one, Nat.add_assoc] using
      prevalid_head_scoped hctxHead₂
  have hHead₁Scoped : Term.Scoped (Γ.depth + 6) head₁ := by
    simpa [Ctx.depth, Nat.succ_eq_add_one, Nat.add_assoc] using
      prevalid_head_scoped hctxSource
  have hHead₆InstScoped :
      Term.Scoped Γ.depth (Term.instantiate 0 arg head₆) :=
  ...
  have hHead₁InstScoped :
      Term.Scoped (Γ.depth + 5)
        (Term.instantiate 5
          (Term.shift 0
            (Term.shift 0 (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))))) head₁) :=
    Term.instantiate_scoped 5 (Γ.depth + 5)
      (Term.shift 0
        (Term.shift 0 (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))))) head₁
      (by omega) hArgShiftShiftShiftShiftShiftScoped hHead₁Scoped
  have hctxTail :
      Prevalid
        ({ bound := Term.instantiate 0 arg head₆, kind := kind₆ } :: Γ) := by
    cases kind₆ with
  ...
  have hctx :
    ...
    | sub => exact Prevalid.sub hctxMid₂ hHead₁InstScoped
    | equ => exact Prevalid.equ hctxMid₂ hHead₁InstScoped
  have hsSource : Stack.Scoped (Γ.depth + 7) s := by
    simpa [Ctx.depth, Nat.succ_eq_add_one, Nat.add_assoc] using
      PrevalidExt.stack_scoped hpv
  have hsTarget :
      Stack.Scoped (Γ.depth + 6)
        (Stack.instantiate 6
          (Term.shift 0
            (Term.shift 0
              (Term.shift 0 (Term.shift 0 (Term.shift 0 (Term.shift 0 arg)))))) s) :=
    Stack.Scoped.instantiate (by omega) hArgShiftShiftShiftShiftShiftShiftScoped (by
      simpa [Nat.add_assoc] using hsSource)
  exact PrevalidExt.of_stack_scoped hctx hsTarget

/-- `MEqRed.top` is stable under de Bruijn β-instantiation below six
preserved context heads. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderSixHeadsStack.top
    {Γ : Ctx} {bound arg head₁ head₂ head₃ head₄ head₅ head₆ : Term}
    {kind₁ kind₂ kind₃ kind₄ kind₅ kind₆ : CtxEntryKind} {s : Stack}
    (hArgBound : WSubMStar Γ arg bound)
    (hpv : PrevalidExt ({ bound := head₁, kind := kind₁ } ::
      ...
      (Stack.instantiate 6
        (Term.shift 0
          (Term.shift 0
            (Term.shift 0 (Term.shift 0 (Term.shift 0 (Term.shift 0 arg)))))) s)
      .top .top :=
  MEqRed.top (BetaInstantiationPreservesPrevalidExtUnderSixHeads
    hArgBound hpv)

/-- `MEqRed.app` is stable under de Bruijn β-instantiation below six
preserved context heads. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderSixHeadsStack.app
    {Γ : Ctx} {arg head₁ head₂ head₃ head₄ head₅ head₆ u u' v v' : Term}
    {kind₁ kind₂ kind₃ kind₄ kind₅ kind₆ : CtxEntryKind} {s : Stack}
    (hFn :
      MEqRed
        ({ bound := Term.instantiate 5
...
β-instantiation below six preserved context heads. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderSixHeadsStack.refl
    {Γ : Ctx} {bound arg head₁ head₂ head₃ head₄ head₅ head₆ u : Term}
    {kind₁ kind₂ kind₃ kind₄ kind₅ kind₆ : CtxEntryKind} {s : Stack}
    (hArgBound : WSubMStar Γ arg bound)
    (hpv : PrevalidExt ({ bound := head₁, kind := kind₁ } ::
        { bound := head₂, kind := kind₂ } ::
    ...
    MEqRed
      ...
      (Term.instantiate 6
        (Term.shift 0
          (Term.shift 0
            (Term.shift 0 (Term.shift 0 (Term.shift 0 (Term.shift 0 arg)))))) u) := by
  have hArgShiftScoped : Term.Scoped (Γ.depth + 1) (Term.shift 0 arg) :=
    Term.shift_scoped 0 Γ.depth arg (Nat.zero_le Γ.depth)
      hArgBound.scoped_left
  have hArgShiftShiftScoped :
  ...
  exact MEqRed.refl
    (BetaInstantiationPreservesPrevalidExtUnderSixHeads hArgBound hpv) hu'

/-- Combined six-preserved-head `MEqRed.var` substitution helper. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderSixHeadsStack.var
    {Γ : Ctx} {bound arg head₁ head₂ head₃ head₄ head₅ head₆ : Term}
    {kind₁ kind₂ kind₃ kind₄ kind₅ kind₆ : CtxEntryKind} {s : Stack} {i : Nat}
    (hArgBound : WSubMStar Γ arg bound)
    (hpv : PrevalidExt ({ bound := head₁, kind := kind₁ } ::
        { bound := head₂, kind := kind₂ } ::
        { bound := head₃, kind := kind₃ } ::
      ...
      (Term.instantiate 6
        (Term.shift 0
          (Term.shift 0
            (Term.shift 0 (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))))))
        (.bvar i)) :=
  BetaInstantiationPreservesMEqRedUnderSixHeadsStack.refl hArgBound hpv
    (Term.Scoped.bvar hi)

/-- `MEqRed.tAp` is stable under de Bruijn β-instantiation below six
preserved context heads. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderSixHeadsStack.tAp
    {Γ : Ctx} {bound arg head₁ head₂ head₃ head₄ head₅ head₆ u : Term}
    {kind₁ kind₂ kind₃ kind₄ kind₅ kind₆ : CtxEntryKind} {s : Stack}
    (hArgBound : WSubMStar Γ arg bound)
    (hpv : PrevalidExt ({ bound := head₁, kind := kind₁ } ::
...
noncomputable def BetaInstantiationPreservesMEqRedUnderFiveHeadsStack.top
    ...
    MEqRed
      ...
      (Term.instantiate 5
        (Term.shift 0
          (Term.shift 0 (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))))) .top)
      (Term.instantiate 5
        (Term.shift 0
          (Term.shift 0 (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))))) .top) := by
  simpa using
...
/-- Reflexive equivalence reduction is stable under de Bruijn
β-instantiation below five preserved context heads. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderFiveHeadsStack.refl
    {Γ : Ctx} {bound arg head₁ head₂ head₃ head₄ head₅ u : Term}
    {kind₁ kind₂ kind₃ kind₄ kind₅ : CtxEntryKind} {s : Stack}
    (hArgBound : WSubMStar Γ arg bound)
    (hpv : PrevalidExt ({ bound := head₁, kind := kind₁ } ::
        { bound := head₂, kind := kind₂ } ::
  ...
  have hu' :
    ...
    have hInst :
      ...
      Term.instantiate_scoped 5 (Γ.depth + 5)
        (Term.shift 0
          (Term.shift 0 (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))))) u
        (by omega) hArgShiftShiftShiftShiftShiftScoped (by
          simpa [Ctx.depth, Nat.succ_eq_add_one, Nat.add_assoc] using hu)
    simpa [Ctx.depth, Nat.succ_eq_add_one, Nat.add_assoc] using hInst
  exact MEqRed.refl
...
/-- `MEqRed.tAp` is stable under de Bruijn β-instantiation below five
preserved context heads. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderFiveHeadsStack.tAp
    {Γ : Ctx} {bound arg head₁ head₂ head₃ head₄ head₅ u : Term}
    {kind₁ kind₂ kind₃ kind₄ kind₅ : CtxEntryKind} {s : Stack}
    (hArgBound : WSubMStar Γ arg bound)
    (hpv : PrevalidExt ({ bound := head₁, kind := kind₁ } ::
...
/-- The five-head `Me-Bet` frontier follows from the five-head equivalence
payload for the argument and the six-preserved-head payload for the body,
plus the de Bruijn substitution-composition law for the deeper β target. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderFiveHeadsBetStackPayload.of_six_heads
    (hFive : BetaInstantiationPreservesMEqRedUnderFiveHeadsStack)
    (hSix : BetaInstantiationPreservesMEqRedUnderSixHeadsStack) :
    BetaInstantiationPreservesMEqRedUnderFiveHeadsBetStackPayload := by
  intro Γ bound arg head₁ head₂ head₃ head₄ head₅ t v v' body body'
    kind₁ kind₂ kind₃ kind₄ kind₅ s hArgBound ht hBody hArg
  have hBodySix := hSix (Γ := Γ) (bound := bound) (arg := arg)
    (head₁ := t) (kind₁ := CtxEntryKind.sub)
    (head₂ := head₁) (kind₂ := kind₁)
    (head₃ := head₂) (kind₃ := kind₂)
    (head₄ := head₃) (kind₄ := kind₃)
        ...
        (Term.instantiate 6
          (Term.shift 0
            (Term.shift 0
              (Term.shift 0 (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))))))
          body') := by
    simpa [Stack.instantiate_six_shift_zero] using hBodySix
  have hArg' := hFive (Γ := Γ) (bound := bound) (arg := arg)
    (head₁ := head₁) (kind₁ := kind₁)
    (head₂ := head₂) (kind₂ := kind₂)
    (head₃ := head₃) (kind₃ := kind₃)
    (head₄ := head₄) (kind₄ := kind₄)
  ...
  have hTarget :
    ...
    exact Term.instantiate_zero_after_five
      (Term.shift 0 (Term.shift 0 (Term.shift 0 (Term.shift 0 (Term.shift 0 arg)))))
      v' body'
  simpa [Term.instantiate, Stack.instantiate, hTarget] using hBet

/-- The five-head `Me-FOp` frontier follows from the five-head equivalence
payload for the abstraction bound and the six-preserved-head payload for
the operand body. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderFiveHeadsFOpStackPayload.of_six_heads
    (hFive : BetaInstantiationPreservesMEqRedUnderFiveHeadsStack)
    (hSix : BetaInstantiationPreservesMEqRedUnderSixHeadsStack) :
    BetaInstantiationPreservesMEqRedUnderFiveHeadsFOpStackPayload := by
  intro Γ bound arg head₁ head₂ head₃ head₄ head₅ t t' α body body'
    kind₁ kind₂ kind₃ kind₄ kind₅ s hArgBound hBound hα hBody
  have hBound' := hFive (Γ := Γ) (bound := bound) (arg := arg)
    (head₁ := head₁) (kind₁ := kind₁)
    (head₂ := head₂) (kind₂ := kind₂)
    (head₃ := head₃) (kind₃ := kind₃)
...
noncomputable def BetaInstantiationPreservesMEqRedUnderFourHeadsStack.refl
    {Γ : Ctx} {bound arg head₁ head₂ head₃ head₄ u : Term}
    {kind₁ kind₂ kind₃ kind₄ : CtxEntryKind} {s : Stack}
    (hArgBound : WSubMStar Γ arg bound)
    (hpv : PrevalidExt ({ bound := head₁, kind := kind₁ } ::
        { bound := head₂, kind := kind₂ } ::
  ...
  have hu' :
    ...
    simpa [Ctx.depth, Nat.succ_eq_add_one, Nat.add_assoc] using hInst
  exact MEqRed.refl
    (BetaInstantiationPreservesPrevalidExtUnderFourHeads hArgBound hpv) hu'

/-- `MEqRed.top` is stable under de Bruijn β-instantiation below four
preserved context heads. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderFourHeadsStack.top
    {Γ : Ctx} {bound arg head₁ head₂ head₃ head₄ : Term}
    {kind₁ kind₂ kind₃ kind₄ : CtxEntryKind} {s : Stack}
    (hArgBound : WSubMStar Γ arg bound)
    (hpv : PrevalidExt ({ bound := head₁, kind := kind₁ } ::
    ...
    MEqRed
      ...
      (Term.instantiate 4
        (Term.shift 0 (Term.shift 0 (Term.shift 0 (Term.shift 0 arg)))) .top) := by
  simpa using
    MEqRed.top (BetaInstantiationPreservesPrevalidExtUnderFourHeads
      hArgBound hpv)

/-- Combined four-preserved-head `MEqRed.var` substitution helper. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderFourHeadsStack.var
    {Γ : Ctx} {bound arg head₁ head₂ head₃ head₄ : Term}
    {kind₁ kind₂ kind₃ kind₄ : CtxEntryKind} {s : Stack} {i : Nat}
    (hArgBound : WSubMStar Γ arg bound)
    (hpv : PrevalidExt ({ bound := head₁, kind := kind₁ } ::
        { bound := head₂, kind := kind₂ } ::
        { bound := head₃, kind := kind₃ } ::
    ...
    MEqRed
      ...
      (Stack.instantiate 4
        (Term.shift 0 (Term.shift 0 (Term.shift 0 (Term.shift 0 arg)))) s)
      (Term.instantiate 4
        (Term.shift 0 (Term.shift 0 (Term.shift 0 (Term.shift 0 arg)))) (.bvar i))
      (Term.instantiate 4
        (Term.shift 0 (Term.shift 0 (Term.shift 0 (Term.shift 0 arg)))) (.bvar i)) :=
  BetaInstantiationPreservesMEqRedUnderFourHeadsStack.refl hArgBound hpv
    (Term.Scoped.bvar hi)

/-- `MEqRed.tAp` is stable under de Bruijn β-instantiation below four
preserved context heads. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderFourHeadsStack.tAp
    {Γ : Ctx} {bound arg head₁ head₂ head₃ head₄ u : Term}
    {kind₁ kind₂ kind₃ kind₄ : CtxEntryKind} {s : Stack}
    (hArgBound : WSubMStar Γ arg bound)
    (hpv : PrevalidExt ({ bound := head₁, kind := kind₁ } ::
...
/-- The `MEqRed.app` constructor reassembles a four-preserved-head
β-instantiated equivalence step from transformed operator and argument
pieces. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderFourHeadsStack.app
    {Γ : Ctx} {arg head₁ head₂ head₃ head₄ u u' v v' : Term}
    {kind₁ kind₂ kind₃ kind₄ : CtxEntryKind} {s : Stack}
    (hFn :
      MEqRed
        ({ bound := Term.instantiate 3
...
/-- The `MEqRed.pro` constructor reassembles four-preserved-head
β-instantiation from the transformed promoted-bound equivalence step. The
index split accounts for all four preserved heads, the discharged `.sub`
head at index `4`, and deeper variables descending by one index. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderFourHeadsStack.pro
    {Γ : Ctx} {bound arg head₁ head₂ head₃ head₄ α α' : Term}
    {kind₁ kind₂ kind₃ kind₄ : CtxEntryKind} {s : Stack} {i : Nat}
    (hArgBound : WSubMStar Γ arg bound)
    (hpv : PrevalidExt ({ bound := head₁, kind := kind₁ } ::
        { bound := head₂, kind := kind₂ } ::
  ...
  have hpvTarget :
      PrevalidExt
        ...
        (Stack.instantiate 4
          (Term.shift 0 (Term.shift 0 (Term.shift 0 (Term.shift 0 arg)))) s) :=
    BetaInstantiationPreservesPrevalidExtUnderFourHeads hArgBound hpv
  cases i with
  | zero =>
      cases kind₁ with
      | sub =>
          ...
          have htargetInst :
              Term.instantiate 4
                ...
                Term.shift 0
                  (Term.instantiate 3
                    (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))) head₁) := by
            exact Term.instantiate_succ_shift_zero 3
              (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))) head₁
          have hαFor :
              MEqRed
                ({ bound := Term.instantiate 3
                  ...
                  Term.instantiate 4
                    ...
                    Term.shift 0
                      (Term.shift 0
                        (Term.instantiate 2
                          (Term.shift 0 (Term.shift 0 arg)) head₂)) := by
                have h := (Term.shiftBy_instantiate 0 2 2
                  (Term.shift 0 (Term.shift 0 arg)) head₂ (Nat.zero_le 2)).symm
                simpa [Term.shift, Term.shiftBy_compose, Nat.add_assoc] using h
              have hαFor :
                  MEqRed
                      ...
                      Term.instantiate 4
                        ...
                        Term.shift 0
                          (Term.shift 0
                            (Term.shift 0
                              (Term.instantiate 1 (Term.shift 0 arg) head₃))) := by
                    have h := (Term.shiftBy_instantiate 0 3 1
                      (Term.shift 0 arg) head₃ (Nat.zero_le 1)).symm
                    simpa [Term.shift, Term.shiftBy_compose, Nat.add_assoc] using h
                  have hαFor :
                      MEqRed
                          ...
                          Term.instantiate 4
                            ...
                            Term.shift 0
                              (Term.shift 0
                                (Term.shift 0
                                  (Term.shift 0 (Term.instantiate 0 arg head₄)))) := by
                        exact Term.instantiate_four_shift_zero arg head₄
                      have hαFor :
                          MEqRed
                            ({ bound := Term.instantiate 3
                                  (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))) head₁,
                      ...
                      have htargetInst :
                          Term.instantiate 4
                            ...
                            Term.shift 0
                              (Term.shift 0
                                (Term.shift 0 (Term.shift 0 tailTarget))) := by
                        exact Term.instantiate_four_shift_zero_tail arg tailTarget
                      have hαFor :
                          MEqRed
                            ({ bound := Term.instantiate 3
                                  (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))) head₁,
...
/-- Assemble four-head equivalence β-instantiation from constructor-local
frontiers. Structural leaves and `Me-Pro` are discharged here; the explicit
inputs are the recursive binder constructors. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderFourHeadsStack.of_constructors
    (hFun : BetaInstantiationPreservesMEqRedUnderFourHeadsFunStackPayload)
    (hBet : BetaInstantiationPreservesMEqRedUnderFourHeadsBetStackPayload)
    (hFOp : BetaInstantiationPreservesMEqRedUnderFourHeadsFOpStackPayload) :
    BetaInstantiationPreservesMEqRedUnderFourHeadsStack := by
  intro Γ bound arg head₁ head₂ head₃ head₄ lhs rhs kind₁ kind₂ kind₃ kind₄ s
    hArgBound hred
  generalize hC : ({ bound := head₁, kind := kind₁ } ::
      { bound := head₂, kind := kind₂ } ::
      { bound := head₃, kind := kind₃ } ::
      { bound := head₄, kind := kind₄ } ::
      { bound := bound, kind := .sub } :: Γ) = C at hred
  induction hred generalizing Γ bound arg head₁ head₂ head₃ head₄
      kind₁ kind₂ kind₃ kind₄ with
  | pro hpv hb hα ih =>
      subst hC
      exact BetaInstantiationPreservesMEqRedUnderFourHeadsStack.pro
        hArgBound hpv hb (ih hArgBound rfl)
  | bet ht hbody harg =>
      subst hC
      exact hBet hArgBound ht hbody harg
  | top hpv =>
      subst hC
      exact BetaInstantiationPreservesMEqRedUnderFourHeadsStack.top
        hArgBound hpv
  | app hOp hArg ihOp ihArg =>
      subst hC
      exact BetaInstantiationPreservesMEqRedUnderFourHeadsStack.app
        (ihOp hArgBound rfl) (ihArg hArgBound rfl)
  | var hpv hi =>
      subst hC
      exact BetaInstantiationPreservesMEqRedUnderFourHeadsStack.var
        hArgBound hpv hi
  | fun_ hBound hBody =>
      subst hC
      exact hFun hArgBound hBound hBody
  | tAp hpv hu =>
      subst hC
      exact BetaInstantiationPreservesMEqRedUnderFourHeadsStack.tAp
        hArgBound hpv hu
  | fOp hBound hα hBody =>
      subst hC
      exact hFOp hArgBound hBound hα hBody
...
/-- The `MEqRed.pro` constructor reassembles three-preserved-head
β-instantiation from the transformed promoted-bound equivalence step. The
index split accounts for all three preserved heads, the discharged `.sub`
head at index `3`, and deeper variables descending by one index. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderThreeHeadsStack.pro
    {Γ : Ctx} {bound arg head₁ head₂ head₃ α α' : Term}
    {kind₁ kind₂ kind₃ : CtxEntryKind} {s : Stack} {i : Nat}
    (hArgBound : WSubMStar Γ arg bound)
    (hpv : PrevalidExt ({ bound := head₁, kind := kind₁ } ::
        { bound := head₂, kind := kind₂ } ::
    ...
    (hα :
      MEqRed
        ...
        (Stack.instantiate 3
          (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))) s)
        (Term.instantiate 3
          (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))) α)
        (Term.instantiate 3
          (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))) α')) :
    MEqRed
      ({ bound := Term.instantiate 2
      ...
      (Term.instantiate 3
        (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))) (.bvar i))
      (Term.instantiate 3
        (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))) α') := by
  have hpvTarget :
      PrevalidExt
        ({ bound := Term.instantiate 2
              (Term.shift 0 (Term.shift 0 arg)) head₁,
        ...
        (Stack.instantiate 3
          (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))) s) :=
    BetaInstantiationPreservesPrevalidExtUnderThreeHeads hArgBound hpv
  cases i with
  | zero =>
      cases kind₁ with
      | sub =>
          ...
          have htargetInst :
              Term.instantiate 3
                ...
                Term.shift 0
                  (Term.instantiate 2
                    (Term.shift 0 (Term.shift 0 arg)) head₁) := by
            exact Term.instantiate_succ_shift_zero 2
              (Term.shift 0 (Term.shift 0 arg)) head₁
          have hαFor :
              MEqRed
                ({ bound := Term.instantiate 2
              ...
              have htargetInst :
                  Term.instantiate 3
                    ...
                    Term.shift 0
                      (Term.shift 0
                        (Term.instantiate 1 (Term.shift 0 arg) head₂)) := by
                have h := (Term.shiftBy_instantiate 0 2 1
                  (Term.shift 0 arg) head₂ (Nat.zero_le 1)).symm
                simpa [Term.shift, Term.shiftBy_compose, Nat.add_assoc] using h
              have hαFor :
                  MEqRed
                  ...
                  have htargetInst :
                      Term.instantiate 3
                        ...
                        Term.shift 0
                          (Term.shift 0
                            (Term.shift 0 (Term.instantiate 0 arg head₃))) := by
                    exact Term.instantiate_three_shift_zero arg head₃
                  have hαFor :
                      MEqRed
                        ({ bound := Term.instantiate 2
                              (Term.shift 0 (Term.shift 0 arg)) head₁,
              ...
              | succ j =>
                  ...
                  have htargetInst :
                      Term.instantiate 3
                        ...
                        Term.shift 0
                          (Term.shift 0 (Term.shift 0 tailTarget)) := by
                    exact Term.instantiate_three_shift_zero_tail arg tailTarget
                  have hαFor :
                      MEqRed
                        ({ bound := Term.instantiate 2
                              (Term.shift 0 (Term.shift 0 arg)) head₁,
...
noncomputable def BetaInstantiationPreservesMEqRedUnderTwoHeadsStack.refl
    {Γ : Ctx} {bound arg head₁ head₂ u : Term}
    {kind₁ kind₂ : CtxEntryKind} {s : Stack}
    (hArgBound : WSubMStar Γ arg bound)
    (hpv : PrevalidExt ({ bound := head₁, kind := kind₁ } ::
        { bound := head₂, kind := kind₂ } ::
    ...
    MEqRed
      ({ bound := Term.instantiate 1 (Term.shift 0 arg) head₁,
        ...
        { bound := Term.instantiate 0 arg head₂, kind := kind₂ } :: Γ)
      (Stack.instantiate 2 (Term.shift 0 (Term.shift 0 arg)) s)
      (Term.instantiate 2 (Term.shift 0 (Term.shift 0 arg)) u)
      (Term.instantiate 2 (Term.shift 0 (Term.shift 0 arg)) u) := by
  have hArgShiftScoped : Term.Scoped (Γ.depth + 1) (Term.shift 0 arg) :=
    Term.shift_scoped 0 Γ.depth arg (Nat.zero_le Γ.depth)
      hArgBound.scoped_left
  have hArgShiftShiftScoped :
  ...
  have hu' :
    ...
    have hInst :
        Term.Scoped (Γ.depth + 2)
          (Term.instantiate 2 (Term.shift 0 (Term.shift 0 arg)) u) :=
      Term.instantiate_scoped 2 (Γ.depth + 2)
        (Term.shift 0 (Term.shift 0 arg)) u (by omega)
        hArgShiftShiftScoped (by
          simpa [Ctx.depth, Nat.succ_eq_add_one, Nat.add_assoc] using hu)
    simpa [Ctx.depth, Nat.succ_eq_add_one, Nat.add_assoc] using hInst
  exact MEqRed.refl
    (BetaInstantiationPreservesPrevalidExtUnderTwoHeads hArgBound hpv) hu'

/-- `MEqRed.top` is stable under de Bruijn β-instantiation below two
preserved context heads. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderTwoHeadsStack.top
    {Γ : Ctx} {bound arg head₁ head₂ : Term}
    {kind₁ kind₂ : CtxEntryKind} {s : Stack}
    (hArgBound : WSubMStar Γ arg bound)
    (hpv : PrevalidExt ({ bound := head₁, kind := kind₁ } ::
    ...
    MEqRed
      ({ bound := Term.instantiate 1 (Term.shift 0 arg) head₁,
        ...
        { bound := Term.instantiate 0 arg head₂, kind := kind₂ } :: Γ)
      (Stack.instantiate 2 (Term.shift 0 (Term.shift 0 arg)) s)
      (Term.instantiate 2 (Term.shift 0 (Term.shift 0 arg)) .top)
      (Term.instantiate 2 (Term.shift 0 (Term.shift 0 arg)) .top) := by
  simpa using
    MEqRed.top (BetaInstantiationPreservesPrevalidExtUnderTwoHeads hArgBound hpv)

/-- Combined two-preserved-head `MEqRed.var` substitution helper. Variables
that land on the substituted tail head reduce reflexively through the scoped
instantiated argument; all other variables are also reflexive leaves. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderTwoHeadsStack.var
    {Γ : Ctx} {bound arg head₁ head₂ : Term}
    ...
    MEqRed
      ...
      (Term.instantiate 2 (Term.shift 0 (Term.shift 0 arg)) (.bvar i)) :=
  BetaInstantiationPreservesMEqRedUnderTwoHeadsStack.refl hArgBound hpv
    (Term.Scoped.bvar hi)

/-- `MEqRed.tAp` is stable under de Bruijn β-instantiation below two
preserved context heads. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderTwoHeadsStack.tAp
    {Γ : Ctx} {bound arg head₁ head₂ u : Term}
    {kind₁ kind₂ : CtxEntryKind} {s : Stack}
    (hArgBound : WSubMStar Γ arg bound)
    (hpv : PrevalidExt ({ bound := head₁, kind := kind₁ } ::
    ...
    MEqRed
      ({ bound := Term.instantiate 1 (Term.shift 0 arg) head₁,
        ...
        { bound := Term.instantiate 0 arg head₂, kind := kind₂ } :: Γ)
      (Stack.instantiate 2 (Term.shift 0 (Term.shift 0 arg)) s)
      (Term.instantiate 2 (Term.shift 0 (Term.shift 0 arg)) (.app .top u))
      (Term.instantiate 2 (Term.shift 0 (Term.shift 0 arg)) .top) := by
  have hArgShiftScoped : Term.Scoped (Γ.depth + 1) (Term.shift 0 arg) :=
    Term.shift_scoped 0 Γ.depth arg (Nat.zero_le Γ.depth)
      hArgBound.scoped_left
...
/-- The `MEqRed.app` constructor reassembles a two-preserved-head
β-instantiated equivalence step from transformed operator and argument
pieces. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderTwoHeadsStack.app
    {Γ : Ctx} {arg head₁ head₂ u u' v v' : Term}
    {kind₁ kind₂ : CtxEntryKind} {s : Stack}
    (hFn :
      MEqRed
        ({ bound := Term.instantiate 1 (Term.shift 0 arg) head₁,
    ...
    MEqRed
      ({ bound := Term.instantiate 1 (Term.shift 0 arg) head₁,
        ...
        { bound := Term.instantiate 0 arg head₂, kind := kind₂ } :: Γ)
      (Stack.instantiate 2 (Term.shift 0 (Term.shift 0 arg)) s)
      (Term.instantiate 2 (Term.shift 0 (Term.shift 0 arg)) (.app u v))
...
/-- The three-head `Me-Fun` frontier follows from the three-head equivalence
payload for the bound and the four-preserved-head payload for the body. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderThreeHeadsFunStackPayload.of_four_heads
    (hThree : BetaInstantiationPreservesMEqRedUnderThreeHeadsStack)
    (hFour : BetaInstantiationPreservesMEqRedUnderFourHeadsStack) :
    BetaInstantiationPreservesMEqRedUnderThreeHeadsFunStackPayload := by
  intro Γ bound arg head₁ head₂ head₃ t t' body body' kind₁ kind₂ kind₃
    hArgBound hBound hBody
  have hBound' := hThree (Γ := Γ) (bound := bound) (arg := arg)
    (head₁ := head₁) (kind₁ := kind₁)
    (head₂ := head₂) (kind₂ := kind₂)
    (head₃ := head₃) (kind₃ := kind₃) (s := []) hArgBound hBound
  have hBody' := hFour (Γ := Γ) (bound := bound) (arg := arg)
    (head₁ := t) (kind₁ := CtxEntryKind.sub)
    (head₂ := head₁) (kind₂ := kind₁)
    (head₃ := head₂) (kind₃ := kind₂)
    (head₄ := head₃) (kind₄ := kind₃) (s := []) hArgBound hBody
...
the operand body. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderThreeHeadsFOpStackPayload.of_four_heads
    (hThree : BetaInstantiationPreservesMEqRedUnderThreeHeadsStack)
    (hFour : BetaInstantiationPreservesMEqRedUnderFourHeadsStack) :
    BetaInstantiationPreservesMEqRedUnderThreeHeadsFOpStackPayload := by
  intro Γ bound arg head₁ head₂ head₃ t t' α body body'
    kind₁ kind₂ kind₃ s hArgBound hBound hα hBody
  have hBound' := hThree (Γ := Γ) (bound := bound) (arg := arg)
    (head₁ := head₁) (kind₁ := kind₁)
    (head₂ := head₂) (kind₂ := kind₂)
    (head₃ := head₃) (kind₃ := kind₃) (s := []) hArgBound hBound
    ...
    have hInst :
        Term.Scoped (Γ.depth + 3)
          (Term.instantiate 3
            (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))) α) :=
      Term.instantiate_scoped 3 (Γ.depth + 3)
        (Term.shift 0 (Term.shift 0 (Term.shift 0 arg))) α (by omega)
        hArgShiftShiftShiftScoped (by
          simpa [Ctx.depth, Nat.succ_eq_add_one, Nat.add_assoc] using hα)
    simpa [Ctx.depth, Nat.succ_eq_add_one, Nat.add_assoc] using hInst
  have hBody' :
...
noncomputable def BetaInstantiationPreservesMEqRedUnderTwoHeadsFunStackPayload.of_three_heads
    ...
    (hThree : BetaInstantiationPreservesMEqRedUnderThreeHeadsStack) :
    BetaInstantiationPreservesMEqRedUnderTwoHeadsFunStackPayload := by
  intro Γ bound arg head₁ head₂ t t' body body' kind₁ kind₂ hArgBound hBound hBody
  have hBound' := hTwo (Γ := Γ) (bound := bound) (arg := arg)
    (head₁ := head₁) (kind₁ := kind₁)
    (head₂ := head₂) (kind₂ := kind₂) (s := []) hArgBound hBound
  have hBody' := hThree (Γ := Γ) (bound := bound) (arg := arg)
    (head₁ := t) (kind₁ := CtxEntryKind.sub)
    (head₂ := head₁) (kind₂ := kind₁)
    (head₃ := head₂) (kind₃ := kind₂) (s := []) hArgBound hBody
  simpa [Term.instantiate] using MEqRed.fun_ hBound' hBody'
...
the operand body. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderTwoHeadsFOpStackPayload.of_three_heads
    (hTwo : BetaInstantiationPreservesMEqRedUnderTwoHeadsStack)
    (hThree : BetaInstantiationPreservesMEqRedUnderThreeHeadsStack) :
    BetaInstantiationPreservesMEqRedUnderTwoHeadsFOpStackPayload := by
  intro Γ bound arg head₁ head₂ t t' α body body' kind₁ kind₂ s
    hArgBound hBound hα hBody
  have hBound' := hTwo (Γ := Γ) (bound := bound) (arg := arg)
    (head₁ := head₁) (kind₁ := kind₁)
    (head₂ := head₂) (kind₂ := kind₂) (s := []) hArgBound hBound
  have hBodyThree := hThree (Γ := Γ) (bound := bound) (arg := arg)
  ...
  have hα' :
    ...
    have hInst :
        Term.Scoped (Γ.depth + 2)
          (Term.instantiate 2 (Term.shift 0 (Term.shift 0 arg)) α) :=
      Term.instantiate_scoped 2 (Γ.depth + 2)
        (Term.shift 0 (Term.shift 0 arg)) α (by omega)
        hArgShiftShiftScoped (by
          simpa [Ctx.depth, Nat.succ_eq_add_one, Nat.add_assoc] using hα)
    simpa [Ctx.depth, Nat.succ_eq_add_one, Nat.add_assoc] using hInst
  have hBody' :
      MEqRed
        ({ bound := Term.instantiate 2
              (Term.shift 0 (Term.shift 0 arg)) α,
            kind := CtxEntryKind.equ } ::
          { bound := Term.instantiate 1 (Term.shift 0 arg) head₁,
            kind := kind₁ } ::
          { bound := Term.instantiate 0 arg head₂, kind := kind₂ } :: Γ)
...
/-- The under-head `Me-Fun` frontier follows from the one-head equivalence
payload for the bound and the two-preserved-head payload for the body. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderHeadFunStackPayload.of_two_heads
    (hEqUnder : BetaInstantiationPreservesMEqRedUnderHeadStack)
    (hTwo : BetaInstantiationPreservesMEqRedUnderTwoHeadsStack) :
    BetaInstantiationPreservesMEqRedUnderHeadFunStackPayload := by
  intro Γ bound arg head t t' body body' kind hArgBound hBound hBody
  have hBound' := hEqUnder (Γ := Γ) (bound := bound) (arg := arg)
    (head := head) (kind := kind) (s := []) hArgBound hBound
  have hBody' := hTwo (Γ := Γ) (bound := bound) (arg := arg)
    (head₁ := t) (kind₁ := CtxEntryKind.sub)
    (head₂ := head) (kind₂ := kind) (s := []) hArgBound hBody
  simpa [Term.instantiate] using MEqRed.fun_ hBound' hBody'
...
operand body. -/
noncomputable def BetaInstantiationPreservesMEqRedUnderHeadFOpStackPayload.of_two_heads
    (hEqUnder : BetaInstantiationPreservesMEqRedUnderHeadStack)
    (hTwo : BetaInstantiationPreservesMEqRedUnderTwoHeadsStack) :
    BetaInstantiationPreservesMEqRedUnderHeadFOpStackPayload := by
  intro Γ bound arg head t t' α body body' kind s hArgBound hBound hα hBody
  have hBound' := hEqUnder (Γ := Γ) (bound := bound) (arg := arg)
    (head := head) (kind := kind) (s := []) hArgBound hBound
  have hBodyTwo := hTwo (Γ := Γ) (bound := bound) (arg := arg)
    (head₁ := α) (kind₁ := CtxEntryKind.equ)
  ...
  have hα' :
    ...
    have hInst :
        Term.Scoped (Γ.depth + 1)
          (Term.instantiate 1 (Term.shift 0 arg) α) :=
      Term.instantiate_scoped 1 (Γ.depth + 1) (Term.shift 0 arg) α
        (by omega) hArgShiftScoped (by
          simpa [Ctx.depth, Nat.succ_eq_add_one, Nat.add_assoc] using hα)
    simpa [Ctx.depth, Nat.succ_eq_add_one] using hInst
  have hBody' :
      MEqRed
        ({ bound := Term.instantiate 1 (Term.shift 0 arg) α,
            kind := CtxEntryKind.equ } ::
          { bound := Term.instantiate 0 arg head, kind := kind } :: Γ)
        (Stack.shift 0 (Stack.instantiate 1 (Term.shift 0 arg) s))
        (Term.instantiate 2 (Term.shift 0 (Term.shift 0 arg)) body)
