...
/-- Instantiation at index `6` through six preserved top-level bindings
commutes with instantiating at index `0` before adding those bindings. -/
theorem instantiate_six_shift_zero (v t : Term) :
    instantiate 6
        (shift 0 (shift 0 (shift 0 (shift 0 (shift 0 (shift 0 v))))))
        (shift 0 (shift 0 (shift 0 (shift 0 (shift 0 (shift 0 t)))))) =
      shift 0
        (shift 0 (shift 0 (shift 0 (shift 0 (shift 0 (instantiate 0 v t)))))) := by
  have h := (shiftBy_instantiate 0 6 0 v t (Nat.zero_le 0)).symm
  simpa [shift, shiftBy_compose, Nat.add_assoc] using h

/-- Instantiation at index `7` through seven preserved top-level bindings
commutes with instantiating at index `0` before adding those bindings. -/
theorem instantiate_seven_shift_zero (v t : Term) :
    instantiate 7
...
/-- Instantiating index `6` through a term shifted under seven top-level
bindings cancels the shift at the instantiated slot and preserves the six
outer bindings. -/
theorem instantiate_six_shift_zero_tail (v t : Term) :
    instantiate 6
        (shift 0 (shift 0 (shift 0 (shift 0 (shift 0 (shift 0 v))))))
        (shift 0
          (shift 0 (shift 0 (shift 0 (shift 0 (shift 0 (shift 0 t))))))) =
      shift 0 (shift 0 (shift 0 (shift 0 (shift 0 (shift 0 t))))) := by
  have h := instantiate_shiftBy_zero_tail 6 v t
  simpa [shift, shiftBy_compose, Nat.add_assoc] using h

/-- Instantiating index `7` through a term shifted under eight top-level
bindings cancels the shift at the instantiated slot and preserves the seven
outer bindings. -/
theorem instantiate_seven_shift_zero_tail (v t : Term) :
    instantiate 7
        (shift 0 (shift 0 (shift 0 (shift 0 (shift 0 (shift 0 (shift 0 v)))))))
        (shift 0
          (shift 0
...
/-- Substituting index `k` after substituting through six preserved slots is
equivalent to first substituting index `k`, then substituting the surviving
slot at `k + 5`. This is the five-preserved-head β-target composition law. -/
theorem instantiate_after_five (k : Nat) (a v t : Term) :
    instantiate k (instantiate (k + 5) a v)
        (instantiate (k + 6) (shift k a) t) =
      instantiate (k + 5) a (instantiate k v t) := by
  induction t generalizing k a v with
  | bvar i =>
      by_cases hlt : i < k
      · have hlt_six : i < k + 6 := by omega
        have hlt_five : i < k + 5 := by omega
        simp [instantiate, hlt, hlt_six, hlt_five]
      · by_cases heq : i = k
        · subst i
          have hnot_six : ¬ k < k := by omega
          have hlt_six : k < k + 6 := by omega
          simp [instantiate, hnot_six, hlt_six]
        · have hgt : k < i := by omega
          by_cases heq_one : i = k + 1
          · subst i
            have hlt_six : k + 1 < k + 6 := by omega
            have hnot : ¬ k + 1 < k := by omega
            have hpred : k + 1 - 1 = k := by omega
            simp [instantiate, hlt, hnot, hlt_six, hpred]
          · by_cases heq_two : i = k + 2
            · subst i
              have hlt_six : k + 2 < k + 6 := by omega
              have hnot : ¬ k + 2 < k := by omega
              have hpred : k + 2 - 1 = k + 1 := by omega
              have hlt_five : k + 1 < k + 5 := by omega
              simp [instantiate, hlt, hnot, hlt_six, hpred, hlt_five]
            · by_cases heq_three : i = k + 3
              · subst i
                have hlt_six : k + 3 < k + 6 := by omega
                have hnot : ¬ k + 3 < k := by omega
                have hpred : k + 3 - 1 = k + 2 := by omega
                have hlt_five : k + 2 < k + 5 := by omega
                simp [instantiate, hlt, hnot, hlt_six, hpred, hlt_five]
              · by_cases heq_four : i = k + 4
                ...
                · by_cases heq_five : i = k + 5
                  · subst i
                    have hlt_six : k + 5 < k + 6 := by omega
                    have hnot : ¬ k + 5 < k := by omega
                    have hpred : k + 5 - 1 = k + 4 := by omega
                    have hlt_five : k + 4 < k + 5 := by omega
                    simp [instantiate, hlt, hnot, hlt_six, hpred, hlt_five]
                  · by_cases heq_six : i = k + 6
                    · subst i
                      have hnlt_lhs₁ : ¬ k + 6 < k + 6 := by omega
                      have hnlt_lhs₂ : ¬ k < k := by omega
                      have hnot_rhs₁ : ¬ k + 6 < k := by omega
                      have hne_rhs₁ : k + 6 ≠ k := by omega
                      have hpred_rhs₁ : k + 6 - 1 = k + 5 := by omega
                      have hnlt_rhs₂ : ¬ k + 5 < k + 5 := by omega
                      have hshift_id :
                          instantiate k (instantiate (k + 5) a v) (shift k a) = a := by
                        exact instantiate_shift_id k (instantiate (k + 5) a v) a
                      simp [instantiate, hnlt_lhs₁, hnlt_lhs₂, hnot_rhs₁,
                        hne_rhs₁, hpred_rhs₁, hnlt_rhs₂, hshift_id]
                    · have hgt_six : k + 6 < i := by omega
                      have hnlt_lhs₁ : ¬ i < k + 6 := by omega
                      have hne_lhs₁ : i ≠ k + 6 := by omega
                      have hnlt_lhs₂ : ¬ i - 1 < k := by omega
                      have hne_lhs₂ : i - 1 ≠ k := by omega
                      have hpred_lhs : i - 1 - 1 = i - 2 := by omega
                      have hnlt_rhs₁ : ¬ i < k := by omega
                      have hne_rhs₁ : i ≠ k := by omega
                      have hnlt_rhs₂ : ¬ i - 1 < k + 5 := by omega
                      have hne_rhs₂ : i - 1 ≠ k + 5 := by omega
                      have hpred_rhs₂ : i - 1 - 1 = i - 2 := by omega
                      simp [instantiate, hnlt_lhs₁, hne_lhs₁, hnlt_lhs₂,
                        hne_lhs₂, hpred_lhs, hnlt_rhs₁, hne_rhs₁,
                        hnlt_rhs₂, hne_rhs₂, hpred_rhs₂]
  ...
  | abs bound body ih_bound ih_body =>
      ...
      · have hbody := ih_body (k + 1) (shift 0 a) (shift 0 v)
        have hshift :
          ...
          exact shift_shift_zero k a
        have hvShift :
            instantiate (k + 6) (shift 0 a) (shift 0 v) =
              shift 0 (instantiate (k + 5) a v) := by
          exact (shiftBy_instantiate 0 1 (k + 5) a v (Nat.zero_le _)).symm
        simpa [Nat.add_assoc, hshift, hvShift] using hbody
  | app fn arg ih_fn ih_arg =>
      simp only [instantiate_app]
      exact congrArg₂ Term.app (ih_fn k a v) (ih_arg k a v)

/-- Zero-cutoff specialization of `Term.instantiate_after_five`. -/
theorem instantiate_zero_after_five (a v t : Term) :
    instantiate 0 (instantiate 5 a v) (instantiate 6 (shift 0 a) t) =
      instantiate 5 a (instantiate 0 v t) :=
  instantiate_after_five 0 a v t

/-- Substituting index `k` after substituting through seven preserved slots is
equivalent to first substituting index `k`, then substituting the surviving
slot at `k + 6`. This is the six-preserved-head β-target composition law. -/
theorem instantiate_after_six (k : Nat) (a v t : Term) :
    instantiate k (instantiate (k + 6) a v)
        (instantiate (k + 7) (shift k a) t) =
      instantiate (k + 6) a (instantiate k v t) := by
  induction t generalizing k a v with
  | bvar i =>
      by_cases hlt : i < k
      · have hlt_seven : i < k + 7 := by omega
        have hlt_six : i < k + 6 := by omega
        simp [instantiate, hlt, hlt_seven, hlt_six]
      · by_cases heq : i = k
        · subst i
          have hnot_seven : ¬ k < k := by omega
          have hlt_seven : k < k + 7 := by omega
          simp [instantiate, hnot_seven, hlt_seven]
        · have hgt : k < i := by omega
          by_cases heq_one : i = k + 1
          · subst i
            have hlt_seven : k + 1 < k + 7 := by omega
            have hnot : ¬ k + 1 < k := by omega
            have hpred : k + 1 - 1 = k := by omega
            simp [instantiate, hlt, hnot, hlt_seven, hpred]
          · by_cases heq_two : i = k + 2
            · subst i
              have hlt_seven : k + 2 < k + 7 := by omega
              have hnot : ¬ k + 2 < k := by omega
              have hpred : k + 2 - 1 = k + 1 := by omega
              have hlt_six : k + 1 < k + 6 := by omega
              simp [instantiate, hlt, hnot, hlt_seven, hpred, hlt_six]
            · by_cases heq_three : i = k + 3
              · subst i
                have hlt_seven : k + 3 < k + 7 := by omega
                have hnot : ¬ k + 3 < k := by omega
                have hpred : k + 3 - 1 = k + 2 := by omega
                have hlt_six : k + 2 < k + 6 := by omega
                simp [instantiate, hlt, hnot, hlt_seven, hpred, hlt_six]
              · by_cases heq_four : i = k + 4
                · subst i
                  have hlt_seven : k + 4 < k + 7 := by omega
                  have hnot : ¬ k + 4 < k := by omega
                  have hpred : k + 4 - 1 = k + 3 := by omega
                  have hlt_six : k + 3 < k + 6 := by omega
                  simp [instantiate, hlt, hnot, hlt_seven, hpred, hlt_six]
                · by_cases heq_five : i = k + 5
                  · subst i
                    have hlt_seven : k + 5 < k + 7 := by omega
                    have hnot : ¬ k + 5 < k := by omega
                    have hpred : k + 5 - 1 = k + 4 := by omega
                    have hlt_six : k + 4 < k + 6 := by omega
                    simp [instantiate, hlt, hnot, hlt_seven, hpred, hlt_six]
                  · by_cases heq_six : i = k + 6
                    · subst i
                      have hlt_seven : k + 6 < k + 7 := by omega
                      have hnot : ¬ k + 6 < k := by omega
                      have hpred : k + 6 - 1 = k + 5 := by omega
                      have hlt_six : k + 5 < k + 6 := by omega
                      simp [instantiate, hlt, hnot, hlt_seven, hpred, hlt_six]
                    · by_cases heq_seven : i = k + 7
                      · subst i
                        have hnlt_lhs₁ : ¬ k + 7 < k + 7 := by omega
                        have hnlt_lhs₂ : ¬ k < k := by omega
                        have hnot_rhs₁ : ¬ k + 7 < k := by omega
                        have hne_rhs₁ : k + 7 ≠ k := by omega
                        have hpred_rhs₁ : k + 7 - 1 = k + 6 := by omega
                        have hnlt_rhs₂ : ¬ k + 6 < k + 6 := by omega
                        have hshift_id :
                            instantiate k (instantiate (k + 6) a v) (shift k a) = a := by
                          exact instantiate_shift_id k (instantiate (k + 6) a v) a
                        simp [instantiate, hnlt_lhs₁, hnlt_lhs₂, hnot_rhs₁,
                          hne_rhs₁, hpred_rhs₁, hnlt_rhs₂, hshift_id]
                      · have hgt_seven : k + 7 < i := by omega
                        have hnlt_lhs₁ : ¬ i < k + 7 := by omega
                        have hne_lhs₁ : i ≠ k + 7 := by omega
                        have hnlt_lhs₂ : ¬ i - 1 < k := by omega
                        have hne_lhs₂ : i - 1 ≠ k := by omega
                        have hpred_lhs : i - 1 - 1 = i - 2 := by omega
                        have hnlt_rhs₁ : ¬ i < k := by omega
                        have hne_rhs₁ : i ≠ k := by omega
                        have hnlt_rhs₂ : ¬ i - 1 < k + 6 := by omega
                        have hne_rhs₂ : i - 1 ≠ k + 6 := by omega
                        have hpred_rhs₂ : i - 1 - 1 = i - 2 := by omega
                        simp [instantiate, hnlt_lhs₁, hne_lhs₁, hnlt_lhs₂,
                          hne_lhs₂, hpred_lhs, hnlt_rhs₁, hne_rhs₁,
                          hnlt_rhs₂, hne_rhs₂, hpred_rhs₂]
  ...
  | abs bound body ih_bound ih_body =>
      ...
      · have hbody := ih_body (k + 1) (shift 0 a) (shift 0 v)
        have hshift :
          ...
          exact shift_shift_zero k a
        have hvShift :
            instantiate (k + 7) (shift 0 a) (shift 0 v) =
              shift 0 (instantiate (k + 6) a v) := by
          exact (shiftBy_instantiate 0 1 (k + 6) a v (Nat.zero_le _)).symm
        simpa [Nat.add_assoc, hshift, hvShift] using hbody
  | app fn arg ih_fn ih_arg =>
      simp only [instantiate_app]
      exact congrArg₂ Term.app (ih_fn k a v) (ih_arg k a v)

/-- Zero-cutoff specialization of `Term.instantiate_after_six`. -/
theorem instantiate_zero_after_six (a v t : Term) :
    instantiate 0 (instantiate 6 a v) (instantiate 7 (shift 0 a) t) =
      instantiate 6 a (instantiate 0 v t) :=
  instantiate_after_six 0 a v t

/-- Substituting index `k` after substituting through eight preserved slots is
equivalent to first substituting index `k`, then substituting the surviving
slot at `k + 7`. This is the seven-preserved-head β-target composition law. -/
theorem instantiate_after_seven (k : Nat) (a v t : Term) :
    instantiate k (instantiate (k + 7) a v)
        (instantiate (k + 8) (shift k a) t) =
      instantiate (k + 7) a (instantiate k v t) := by
  induction t generalizing k a v with
  | bvar i =>
      by_cases hlt : i < k
      · have hlt_eight : i < k + 8 := by omega
        have hlt_seven : i < k + 7 := by omega
        simp [instantiate, hlt, hlt_eight, hlt_seven]
      · by_cases heq : i = k
        · subst i
          have hnot_eight : ¬ k < k := by omega
          have hlt_eight : k < k + 8 := by omega
          simp [instantiate, hnot_eight, hlt_eight]
        · have hgt : k < i := by omega
          by_cases heq_one : i = k + 1
          · subst i
            have hlt_eight : k + 1 < k + 8 := by omega
            have hnot : ¬ k + 1 < k := by omega
            have hpred : k + 1 - 1 = k := by omega
            simp [instantiate, hlt, hnot, hlt_eight, hpred]
          · by_cases heq_two : i = k + 2
            · subst i
              have hlt_eight : k + 2 < k + 8 := by omega
              have hnot : ¬ k + 2 < k := by omega
              have hpred : k + 2 - 1 = k + 1 := by omega
              have hlt_seven : k + 1 < k + 7 := by omega
              simp [instantiate, hlt, hnot, hlt_eight, hpred, hlt_seven]
            · by_cases heq_three : i = k + 3
              · subst i
                have hlt_eight : k + 3 < k + 8 := by omega
                have hnot : ¬ k + 3 < k := by omega
                have hpred : k + 3 - 1 = k + 2 := by omega
                have hlt_seven : k + 2 < k + 7 := by omega
                simp [instantiate, hlt, hnot, hlt_eight, hpred, hlt_seven]
              · by_cases heq_four : i = k + 4
                · subst i
                  have hlt_eight : k + 4 < k + 8 := by omega
                  have hnot : ¬ k + 4 < k := by omega
                  have hpred : k + 4 - 1 = k + 3 := by omega
                  have hlt_seven : k + 3 < k + 7 := by omega
                  simp [instantiate, hlt, hnot, hlt_eight, hpred, hlt_seven]
                · by_cases heq_five : i = k + 5
                  · subst i
                    have hlt_eight : k + 5 < k + 8 := by omega
                    have hnot : ¬ k + 5 < k := by omega
                    have hpred : k + 5 - 1 = k + 4 := by omega
                    have hlt_seven : k + 4 < k + 7 := by omega
                    simp [instantiate, hlt, hnot, hlt_eight, hpred, hlt_seven]
                  · by_cases heq_six : i = k + 6
                    · subst i
                      have hlt_eight : k + 6 < k + 8 := by omega
                      have hnot : ¬ k + 6 < k := by omega
                      have hpred : k + 6 - 1 = k + 5 := by omega
                      have hlt_seven : k + 5 < k + 7 := by omega
                      simp [instantiate, hlt, hnot, hlt_eight, hpred, hlt_seven]
                    · by_cases heq_seven : i = k + 7
                      · subst i
                        have hlt_eight : k + 7 < k + 8 := by omega
                        have hnot : ¬ k + 7 < k := by omega
                        have hpred : k + 7 - 1 = k + 6 := by omega
                        have hlt_seven : k + 6 < k + 7 := by omega
                        simp [instantiate, hlt, hnot, hlt_eight, hpred, hlt_seven]
                      · by_cases heq_eight : i = k + 8
                        · subst i
                          have hnlt_lhs₁ : ¬ k + 8 < k + 8 := by omega
                          have hnlt_lhs₂ : ¬ k < k := by omega
                          have hnot_rhs₁ : ¬ k + 8 < k := by omega
                          have hne_rhs₁ : k + 8 ≠ k := by omega
                          have hpred_rhs₁ : k + 8 - 1 = k + 7 := by omega
                          have hnlt_rhs₂ : ¬ k + 7 < k + 7 := by omega
                          have hshift_id :
                              instantiate k (instantiate (k + 7) a v) (shift k a) = a := by
                            exact instantiate_shift_id k (instantiate (k + 7) a v) a
                          simp [instantiate, hnlt_lhs₁, hnlt_lhs₂, hnot_rhs₁,
                            hne_rhs₁, hpred_rhs₁, hnlt_rhs₂, hshift_id]
                        · have hgt_eight : k + 8 < i := by omega
                          have hnlt_lhs₁ : ¬ i < k + 8 := by omega
                          have hne_lhs₁ : i ≠ k + 8 := by omega
                          have hnlt_lhs₂ : ¬ i - 1 < k := by omega
                          have hne_lhs₂ : i - 1 ≠ k := by omega
                          have hpred_lhs : i - 1 - 1 = i - 2 := by omega
                          have hnlt_rhs₁ : ¬ i < k := by omega
                          have hne_rhs₁ : i ≠ k := by omega
                          have hnlt_rhs₂ : ¬ i - 1 < k + 7 := by omega
                          have hne_rhs₂ : i - 1 ≠ k + 7 := by omega
                          have hpred_rhs₂ : i - 1 - 1 = i - 2 := by omega
                          simp [instantiate, hnlt_lhs₁, hne_lhs₁, hnlt_lhs₂,
                            hne_lhs₂, hpred_lhs, hnlt_rhs₁, hne_rhs₁,
                            hnlt_rhs₂, hne_rhs₂, hpred_rhs₂]
  ...
  | abs bound body ih_bound ih_body =>
      ...
      · have hbody := ih_body (k + 1) (shift 0 a) (shift 0 v)
        have hshift :
          ...
          exact shift_shift_zero k a
        have hvShift :
            instantiate (k + 8) (shift 0 a) (shift 0 v) =
              shift 0 (instantiate (k + 7) a v) := by
          exact (shiftBy_instantiate 0 1 (k + 7) a v (Nat.zero_le _)).symm
        simpa [Nat.add_assoc, hshift, hvShift] using hbody
  | app fn arg ih_fn ih_arg =>
      simp only [instantiate_app]
      exact congrArg₂ Term.app (ih_fn k a v) (ih_arg k a v)

/-- Zero-cutoff specialization of `Term.instantiate_after_seven`. -/
theorem instantiate_zero_after_seven (a v t : Term) :
    instantiate 0 (instantiate 7 a v) (instantiate 8 (shift 0 a) t) =
      instantiate 7 a (instantiate 0 v t) :=
  instantiate_after_seven 0 a v t
