...
theorem instantiate_after_two (k : Nat) (a v t : Term) :
  ...
  simpa [Nat.add_assoc] using instantiate_after_many 1 k a v t
...
theorem instantiate_after_three (k : Nat) (a v t : Term) :
  ...
  simpa [Nat.add_assoc] using instantiate_after_many 2 k a v t
...
theorem instantiate_after_four (k : Nat) (a v t : Term) :
  ...
  simpa [Nat.add_assoc] using instantiate_after_many 3 k a v t
...
theorem instantiate_after_five (k : Nat) (a v t : Term) :
  ...
  simpa [Nat.add_assoc] using instantiate_after_many 4 k a v t
...
theorem instantiate_after_six (k : Nat) (a v t : Term) :
  ...
  simpa [Nat.add_assoc] using instantiate_after_many 5 k a v t
