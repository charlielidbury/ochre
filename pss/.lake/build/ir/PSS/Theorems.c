...
// Module: PSS.Theorems
// Imports: Init PSS.Syntax PSS.Reduction PSS.Declarative PSS.Algorithmic
#include <lean/lean.h>
...
extern "C" {
#endif
LEAN_EXPORT lean_object* l_PSS_ptsTranslate(lean_object*);
LEAN_EXPORT lean_object* l_PSS_ptsTranslate___boxed(lean_object*);
LEAN_EXPORT lean_object* l_PSS_ptsTranslate(lean_object* x_1) {
_start:
{
lean_inc(x_1);
return x_1;
...
LEAN_EXPORT lean_object* l_PSS_ptsTranslate___boxed(lean_object* x_1) {
_start:
{
lean_object* x_2; 
x_2 = l_PSS_ptsTranslate(x_1);
lean_dec(x_1);
return x_2;
}
}
...
LEAN_EXPORT lean_object* initialize_PSS_Theorems(uint8_t builtin, lean_object* w) {
lean_object * res;
